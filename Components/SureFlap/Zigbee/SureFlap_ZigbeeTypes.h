...
typedef enum
{
	SUREFLAP_PAIRING_REQUEST_SOURCE_UNKNOWN,
	SUREFLAP_PAIRING_REQUEST_SOURCE_SERVER,
	SUREFLAP_PAIRING_REQUEST_SOURCE_BUTTON,
	SUREFLAP_PAIRING_REQUEST_SOURCE_CLI,
	SUREFLAP_PAIRING_REQUEST_SOURCE_TIMEOUT,
	SUREFLAP_PAIRING_REQUEST_SOURCE_BEACON_REQUEST,
